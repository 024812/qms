...
import { CardCard } from '@/modules/cards/ui/CardCard'; // Ensure this path is correct
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">
          Manage your sports card collection, track values, and grading.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Start building your collection by adding a new card."
          action={{
            label: 'Add Card',
