...
export default async function CardOverviewPage({ params }: Props) {
  ...
  const t = await getTranslations('sidebar'); // Uses 'sidebar' namespace as keys are there
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">
          Identify trends and track the value of your collection
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm">
          <div className="p-6 flex flex-row items-center justify-between space-y-0 pb-2">
            <h3 className="tracking-tight text-sm font-medium">Collection Cost</h3>
            <DollarSign className="h-4 w-4 text-muted-foreground" />
          </div>
          <div className="p-6 pt-0">
            <div className="text-2xl font-bold">{formatCurrency(stats.collectionCost)}</div>
            <p className="text-xs text-muted-foreground">Total cost of unsold cards</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm">
          ...
          <div className="p-6 pt-0">
            ...
            <p className="text-xs text-muted-foreground">Lifetime purchase amount</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm">
          ...
          <div className="p-6 pt-0">
            ...
            <p className="text-xs text-muted-foreground">Total revenue from sold cards</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm">
          ...
          <div className="p-6 pt-0">
            ...
            <p className="text-xs text-muted-foreground">Profit from sold cards</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border bg-card p-6">
          ...
          <div className="h-[200px] flex items-center justify-center text-muted-foreground bg-muted/20 rounded-lg">
            Chart Placeholder (Brand/Year/Sport)
          </div>
        </div>
        <div className="rounded-xl border bg-card p-6">
          <h3 className="font-semibold mb-4">Recent Activity</h3>
          <div className="h-[200px] flex items-center justify-center text-muted-foreground bg-muted/20 rounded-lg">
            List Placeholder (Recent Adds/Sales)
          </div>
        </div>
      </div>
    </div>
