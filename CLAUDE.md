...
Next.js 16 App Router (React 19, TypeScript). The codebase follows a strict **module blueprint** documented in `docs/architecture/MODULE_BLUEPRINT_V3.md`. `quilts` and `cards` are the canonical template modules; new modules copy their structure rather than inventing new patterns.
